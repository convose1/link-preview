...
- Timeout: at least 15s (see DEPLOYMENT.md). The default 3s is too short for sites with redirects or slow responses (github.com, bbc.com, sonarcloud.io) and surfaces as opaque API Gateway 500s.
...
**Build, deploy, function configuration and rollback: see [DEPLOYMENT.md](DEPLOYMENT.md).** It documents the sequence all three Convose Lambdas share.
